...
from {{cookiecutter.project_slug}}.blog.models import Post 
from {{cookiecutter.project_slug}}.blog.selectors.posts import post_detail, post_list 
from {{cookiecutter.project_slug}}.blog.services.post import create_post 
